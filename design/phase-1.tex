...
\section{Client library domain model}
	...
	\includegraphics[width=\linewidth]{build/phase-1/conceptual-domain-model.png}


\section{Client library state model}
	
	\begin{center}
		\includegraphics[width=0.8\linewidth]{build/phase-1/application-state-client.png}
	\end{center}
...
\section{Database server state model}
	...
	\includegraphics[width=\linewidth]{build/phase-1/application-state-server.png}
...
\section{Use cases}
	...
	\begin{center}
		\makebox[\textwidth][c]{\includegraphics[width=0.7\paperwidth]{build/phase-1/use-case.png}}
	\end{center}
...
Client Library returns success.
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-connect-to-database-server.png}
		\end{center}
...
Library returns results to Client
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-all-commands.png}
		\end{center}
...
Database Server returns value associated with the key
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-get-command.png}
		\end{center}
...
Database Server always returns that the operation succeeded
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-set-command.png}
		\end{center}
...
Database Server returns the number of keys deleted
	with that name
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-del-command.png}
		\end{center}
...
Otherwise, the Database Server returns that the operation failed
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-essential-move-command.png}
		\end{center}
...
Otherwise, the server terminates with an error
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{build/phase-1/use-case-essential-graceful-recovery-during-startup.png}
		\end{center}
...
\section{Concrete use cases}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-connect-to-database-server.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-library-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-cli-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-backend-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\makebox[\textwidth][c]{\includegraphics[width=0.8\paperwidth]{build/phase-1/use-case-concrete-maintain-data.png}}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=0.8\linewidth]{build/phase-1/use-case-concrete-del-statement.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-move-statement.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-get-statement.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-set-statement.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{build/phase-1/use-case-concrete-startup-consistency-verification.png}
		\end{center}
...
\section{Model}
	...
	\begin{center}
		\includegraphics[width=\linewidth]{build/phase-1/application-class-model.png}
	\end{center}
...
\section{Client library state classes}
	...
	\subsection{Database Context}
		\includegraphics[width=\linewidth]{build/phase-1/application-class-state-client-database-context.png}
	\subsection{Transaction}
		\includegraphics[width=0.7\linewidth]{build/phase-1/application-class-state-client-transaction.png}
...
\section{Database server state classes}
	...
	\subsection{Database}
		\includegraphics[width=\linewidth]{build/phase-1/application-class-state-server-database.png}
	\subsection{Data Controller}
		\includegraphics[width=0.8\linewidth]{build/phase-1/application-class-state-server-data-controller.png}
