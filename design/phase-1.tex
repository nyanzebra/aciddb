...
\section{Client library domain model}
	...
	\includegraphics[width=\linewidth]{class-diagrams/client-classes.png}
...
\section{Database server domain model}
	...
	\begin{center}
		\makebox[\textwidth][c]{\includegraphics[width=0.8\paperwidth]{class-diagrams/server-classes.png}}
	\end{center}

\section{Client library state model}
	
	\begin{center}
		\includegraphics[width=0.8\linewidth]{state-diagrams/uml-client-state.png}
	\end{center}
...
\section{Database server state model}
	...
	\includegraphics[width=\linewidth]{state-diagrams/uml-server-state.png}
...
\section{Use cases}
	...
	\begin{center}
		\makebox[\textwidth][c]{\includegraphics[width=0.7\paperwidth]{use-case-diagram/use-case-diagram.png}}
	\end{center}
...
Client Library returns success.
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-connect-to-database-server.png}
		\end{center}
...
Library returns results to Client
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-all-commands.png}
		\end{center}
...
Database Server returns value associated with the key
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-get-command.png}
		\end{center}
...
Database Server always returns that the operation succeeded
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-set-command.png}
		\end{center}
...
Database Server returns the number of keys deleted
	with that name
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-delete-command.png}
		\end{center}
...
Otherwise, the Database Server returns that the operation failed
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/essential-sequences-move-command.png}
		\end{center}
...
Otherwise, the server terminates with an error
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{sequence-diagrams/essential-sequences-graceful-recovery.png}
		\end{center}
...
\section{Concrete use cases}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-connect-to-database.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-library-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-cli-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-backend-process-transaction.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-maintain-data.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=0.8\linewidth]{sequence-diagrams/datastore-process-delete-sequence.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/datastore-process-move-sequence.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/datastore-get-record-sequence.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=0.6\linewidth]{sequence-diagrams/datastore-process-delete-sequence.png}
		\end{center}
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/datastore-process-create-sequence.png}
		\end{center}
	...
	\begin{description}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{sequence-diagrams/concrete-sequences-startup-consistency.png}
		\end{center}
...
\section{Client library state classes}
	...
	\includegraphics[width=0.8\linewidth]{class-diagrams/client-classes.png}

	\subsection{Database Context}
		\includegraphics[width=\linewidth]{state-diagrams/database-context-application-state.png}
	\subsection{Transaction}
		\includegraphics[width=0.7\linewidth]{state-diagrams/transaction-application-state.png}
	\subsection{Network}
		\includegraphics[width=\linewidth]{state-diagrams/network-application-state.png}
...
\section{Database server state classes}
	...
	\subsection{Client Connection}
		\includegraphics[width=\linewidth]{state-diagrams/client-connection-application-state.png}
	\subsection{Database}
		\includegraphics[width=\linewidth]{state-diagrams/database-application-state.png}
	\subsection{Data Controller}
		\includegraphics[width=0.8\linewidth]{state-diagrams/data-controller-application-state.png}
	\subsection{Network}
		\includegraphics[width=0.8\linewidth]{state-diagrams/network-application-state.png}
